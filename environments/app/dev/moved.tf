...
moved {
  from = google_project_iam_member.report_sa_service_usage
  to   = module.app.google_project_iam_member.report_sa_service_usage
}
...
moved {
  ...
  to   = module.app.module.run_console[0]
}

moved {
  from = module.global_lb
  to   = module.app.module.global_lb[0]
}

moved {
  from = google_iap_web_backend_service_iam_binding.console
  to   = module.app.google_iap_web_backend_service_iam_binding.console[0]
}
