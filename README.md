...
5. Smoke test Core API endpoints, confirm Cloud Run jobs, and update `planning/change_log.md` with noteworthy outcomes.
...
- **`alreadyExists: Service account ...` during apply**
  ...
  - Repeat for any other pre-existing accounts (`core-svc`, etc.).
