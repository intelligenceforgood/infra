...
- `provider_id` – identifier for the provider (e.g., `proto`).
...
module "github_wif" {
	...
	provider_id       = "proto"
	github_repository = "intelligenceforgood/proto"
}
...
resource "google_service_account_iam_binding" "infra_wif" {
	...
	members = [
		"principalSet://iam.googleapis.com/${module.github_wif.pool_name}/attribute.repository/intelligenceforgood/proto"
	]
}
```
