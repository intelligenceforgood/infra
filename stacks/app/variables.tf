...
# App Stack — Variables
#
# Unified variable interface for the app stack. Values come from the
# thin environment wrappers via terraform.tfvars / local-overrides.tfvars.
# ---------------------------------------------------------------------------
...
variable "core_svc_invoker_member" {
  type        = string
  description = "Principal granted Cloud Run invoker on the Core API service (leave blank to skip)."
  default     = ""
}
...
variable "core_svc_custom_domain" {
  type        = string
  description = "Optional custom domain to map to the Core API service."
  default     = ""
}

variable "core_svc_events_url" {
  type        = string
  description = "Direct Cloud Run URL for core-svc. Used by ssi-svc to push investigation events bypassing the IAP load-balancer."
  default     = ""
}
...
variable "ui_custom_domain" {
  type        = string
  description = "Optional custom domain to map to the UI service."
  default     = ""
}
...
variable "dns_managed_zone" {
  type        = string
  description = "Optional Cloud DNS managed zone name to create DNS records in for the custom domains."
  default     = ""
}
